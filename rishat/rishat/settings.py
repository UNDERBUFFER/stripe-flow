...
SECRET_KEY = 'django-insecure-a9=gs!$fgx*y_+1k^f4j7yf05y33_%@em3ty)73he0nlx_2+rr'
...
INSTALLED_APPS = [
    ...
    'django.contrib.messages', 'django.contrib.staticfiles', 'sale'
]
...
DB_CONNECTION_STRING = urlparse(ENV['DB_CONNECTION_STRING'])

DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': DB_CONNECTION_STRING.path[1:],
